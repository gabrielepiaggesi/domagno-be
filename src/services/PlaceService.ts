...
export class PlaceService implements PlaceApi {
    ...
    public async getNearByRestaurants(queryString: string, radius: number, count: number, lat: number, long: number) {
        ...
        return await Axios.get(`https://serpapi.com/search.json?engine=google_maps&q=${encodeURI(queryString)}&ll=@${lat},${long},${zl.toFixed(1)}z&type=search&api_key=ff9b7f25b03611bd201574335b3ae0334890097cf4ae1b5c9a43e60bbb7f0309`);
    }
