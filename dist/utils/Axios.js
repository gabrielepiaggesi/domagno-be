...
class Axios {
    static get(token, endpoint, contentType = 'application/json') {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield axios_1.default.get(endpoint, getHeaders(token, contentType))).data;
        });
    }
    static post(token, endpoint, body, contentType = 'application/json', extraHeaders = null) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield axios_1.default.post(endpoint, body, getHeaders(token, contentType, extraHeaders))).data;
        });
    }
