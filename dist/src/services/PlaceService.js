...
class PlaceService {
    getNearByRestaurants(queryString, radius, count, lat, long) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield Axios_1.Axios.get(`https://serpapi.com/search.json?engine=google_maps&q=${encodeURI(queryString)}&ll=@${lat},${long},${zl.toFixed(1)}z&type=search&api_key=ff9b7f25b03611bd201574335b3ae0334890097cf4ae1b5c9a43e60bbb7f0309`);
        });
    }
}
